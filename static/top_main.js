...
async function fetchMenuData() {
    try {
        ...
        const response = await fetch('https://kkuyemekhanepuanla.com.tr/menu', {
            headers: {
...
async function updateOverallAverage() {
    ...
    try {
        const response = await fetch(`https://kkuyemekhanepuanla.com.tr/api/averages/${today}`);
        const data = await response.json();
...
async function updateDishAverages() {
    ...
    try {
        const response = await fetch(`https://kkuyemekhanepuanla.com.tr/api/dish-averages/${today}`);
        const data = await response.json();
...
async function handleRatingSubmission() {
    ...
    try {
        const response = await fetch("https://kkuyemekhanepuanla.com.tr/submit-ratings", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`,
...
async function addComment() {
    ...
    try {
        const response = await fetch('https://kkuyemekhanepuanla.com.tr/submit-comment', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`
            },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!token) {
        showErrorToast('Lütfen önce giriş yapın!');
        window.location.href = "https://kkuyemekhanepuanla.com.tr/giris";
        return;
    }
