document.getElementById('verify-form').addEventListener('submit', async (event) => {
    ...
    try {
        ...
        const response = await fetch('https://kkuyemekhanepuanla.com.tr/verify-code', {
            method: 'POST',
            headers: {
        ...
        if (response.ok && data.success) {
            const signupResponse = await fetch('https://kkuyemekhanepuanla.com.tr/kaydol', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (signupResponse.ok) {
                ...
                window.location.href = "https://kkuyemekhanepuanla.com.tr/static/index.html";
